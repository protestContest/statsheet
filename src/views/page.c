...
bool PageInput(View *view, u16 input)
{
  ...
  if (KeyPressed(BTN_LEFT)) {
    ...
    SelectView(page, selected->up);
  } else if (KeyPressed(BTN_DOWN)) {
    SelectView(page, selected->down);
  } else {
